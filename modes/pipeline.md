...
Processes offer URLs accumulated in `data/pipeline.md`. The user adds URLs whenever they like and then runs `/career-ops pipeline` to process them all.
...
```
If there is a desynchronisation, warn the user before continuing.
